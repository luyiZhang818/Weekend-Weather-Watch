...
func InitCron(client *mongo.Client, channel *amqp.Channel) {
	mongoClient = client
...
func requestDailyWeatherData(userPreferences UserPreferences) error {
	message := Message{
		Action: "FetchWeather",
...
func getAllUserPreferences() []UserPreferences {
	var allUserPreferences []UserPreferences
